...
class ForumService final {
 public:
  ...
  typedef WithAsyncMethod_CreatePost<Service > AsyncService;
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_CreatePost : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_CreatePost() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_CreatePost<Service > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_CreatePost<Service > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_CreatePost : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_CreatePost() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->CreatePost(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_CreatePost() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status CreatePost(::grpc::ServerContext* /*context*/, const ::peony::forum::models::CreatePostRequest* /*request*/, ::google::protobuf::Empty* /*response*/) override {
